...
<script>import { mapState } from 'vuex';
  ...
  export default {
    ...
    data: () => ({
      ...
      contest:[
        {
          title: "제8회 안전한 학교 공모전 UCC 부문 대국민 심사",
          field: "디자인,UCC/영상,예체능,경품/이벤트",
        ...
        },
        {
          ...
          field: "기획/아이디어,디자인,광고/마케팅,UCC/영상",
        ...
        },
        {
          ...
          field: "기획/아이디어,디자인,UCC/영상,예체능,캐릭터/만화",
